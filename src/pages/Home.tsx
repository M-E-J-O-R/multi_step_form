        ...
        <div className={style.info_contanier}>
            ...
            <form action="" className={style.form_container}>
                <label htmlFor="name" className={style.label_container}>
                    ...
                    <input type="text" autoComplete='on' id="name" required placeholder='Vannesa Mint' onChange={(e) => handleUserInfo('name', e.target.value)} value={userInfo.name} className={style.input_field} />
                </label>
                <label htmlFor="email" className={style.label_container}>
                    <p className={style.label_text}>Email</p>
                    <input type="email" autoComplete='on' id="email" required placeholder='vannesamint@' className={style.input_field} onChange={(e) => handleUserInfo('email', e.target.value)} value={userInfo.email} />
                </label>
                <label htmlFor="phone" className={style.label_container}>
                    <p className={style.label_text}>Phone</p>
                    <input type="tel" autoComplete='on' id="phone" required placeholder='+1 234 567 890' className={style.input_field} onChange={(e) => handleUserInfo('telephone', e.target.value)} value={userInfo.telephone} />
                </label>
            </form>
